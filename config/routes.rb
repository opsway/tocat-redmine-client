...
match '/tocat/orders/:id/completed' => 'orders#toggle_completed', as: :order_complete, via: [:post, :put]
match '/tocat/orders/:id/completed' => 'orders#toggle_completed', as: :order_uncomplete, via: [:delete]
